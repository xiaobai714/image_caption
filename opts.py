...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--iter_id', type=str, default=None,
                    help='model iter id for continue training')
    ...
    parser.add_argument('--logit_layers', type=int, default=1,
                    help='number of layers in the RNN')
    parser.add_argument('--despective_model_on', type=int, default=0,
                    help = 'whether use descriptive model, 0 mean not use, 1 mean use')
